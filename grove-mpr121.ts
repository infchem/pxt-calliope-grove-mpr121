...
namespace grove_mpr121 {
    ...
    export function init(): void {
		...
		// von Adafruit hingegen schon (http://multiwingspan.co.uk/micro.php?page=mpr121)
		 ...
		 const regval: number[] = [0x4106, 0x420C, 0x4306, 0x440C, 0x4506, 0x460C, 0x4706, 0x480C,
  ...
  const feeler: number[] = [256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 1, 2, 4, 8];
		const result = pins.i2cReadNumber(ADDRESS, NumberFormat.UInt16BE);
		if (result == 0) {
